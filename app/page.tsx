...
// Deine echten Vinted-Produkte mit korrekten Links
const products = [
  {
    id: 1,
    ...
    vintedUrl: "https://www.vinted.de/items/8322236551-the-north-face-pufferjacke"
  },
  {
    id: 2,
    ...
    vintedUrl: "https://www.vinted.de/items/8400248375-lacoste-track-jacket-windbreaker"
  },
  {
    id: 3,
    ...
    vintedUrl: "https://www.vinted.de/items/8323545774-adidas-originals-puffer-jacke-blau"
  },
  {
    id: 4,
    ...
    vintedUrl: "https://www.vinted.de/items/8436257572-adidas-originals-track-jacket-rot"
  },
  {
    id: 5,
    ...
    vintedUrl: "https://www.vinted.de/items/8416878208-adidas-fleece-jacke-schwarz"
  },
  {
    id: 6,
    ...
    vintedUrl: "https://www.vinted.de/items/8320129694-reebok-ny-rangers-fleecejacke"
  },
  {
    id: 7,
    ...
    vintedUrl: "https://www.vinted.de/items/8410133047-la-martina-steppweste-schwarz-rot"
  },
  {
    id: 8,
    ...
    vintedUrl: "https://www.vinted.de/items/8448746258-tommy-hilfiger-teddy-fleece-hoodie"
  },
  {
    id: 9,
    ...
    vintedUrl: "https://www.vinted.de/items/8417156956-tommy-hilfiger-teddy-fleece-quarter-zip"
  },
  {
    id: 10,
    ...
    vintedUrl: "https://www.vinted.de/items/8414805903-helly-hansen-fleece-half-zip"
  },
  {
    id: 11,
    ...
    vintedUrl: "https://www.vinted.de/items/8440569340-timberland-fleece-quarter-zip"
  },
  {
    id: 12,
    ...
    vintedUrl: "https://www.vinted.de/items/8440675699-nike-cropped-fleece-crewneck-beige"
  },
  {
    id: 13,
    ...
    vintedUrl: "https://www.vinted.de/items/8414236896-lee-sport-wisconsin-badgers-sweatshirt"
  },
  {
    id: 14,
    ...
    vintedUrl: "https://www.vinted.de/items/8414786154-lee-sport-wisconsin-badgers-crewneck"
  },
  {
    id: 15,
    ...
    vintedUrl: "https://www.vinted.de/items/8441012104-vintage-england-strickjacke-union-jack"
  }
];
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-[#F5F5F5] font-sans selection:bg-[#FF4400] selection:text-white">
      ...
      <section id="products" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
              ...
              <button
                ...
                className={`px-4 py-2 text-xs uppercase tracking-widest border transition-all ${
                  activeCategory === cat
                    ...
                    : 'border-[#1A1A1A] text-gray-400 hover:border-[#FF4400] hover:text-[#FF4400]'
                }`}
              >
                {cat}
              </button>
          ...
          {/* Products - MIT ZOOM-FIX: Text bleibt im Rahmen */}
          <AnimatePresence mode="wait">
            ...
            >
              {filteredProducts.map((product, index) => (
                ...
                >
                  {/* Image Container - ZOOM nur auf Bild */}
                  ...
                  {/* Info - KEIN ZOOM, nur Farbwechsel */}
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-2">
                      <div className="min-w-0 pr-2">
                        <p className="text-xs text-gray-500 uppercase tracking-widest mb-1">{product.category}</p>
                        <h3 className="text-lg font-bold uppercase tracking-tight group-hover:text-[#FF4400] transition-colors leading-tight line-clamp-2">
                          {product.name}
                        </h3>
                      </div>
              ...
              <div className="aspect-square bg-[#0A0A0A] border border-[#FF4400]/20 p-8 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm uppercase tracking-widest">
                    ...
                    <div className="p-4 bg-[#1A1A1A] border border-[#0A1A1A]">
                    ...
                    <div className="p-4 bg-[#1A1A1A] border border-[#0A0A0A]">
                      <span className="block text-2xl font-bold text-[#FF4400]">15</span>
