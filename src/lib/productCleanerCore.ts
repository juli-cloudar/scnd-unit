// src/lib/productCleanerCore.ts
// Diese Datei hat KEIN "use client" und kann überall verwendet werden
...
/**
 * Bereinigt und bereitet Produkte für Supabase vor
 */
