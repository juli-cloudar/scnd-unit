...
export function DataPrivacy({ isOpen, onClose }: DataPrivacyProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="relative max-w-2xl w-full max-h-[80vh] overflow-y-auto rounded-xl bg-[var(--bg-primary)] border border-[#FF4400]/30 shadow-xl">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-1 rounded-full hover:bg-[#FF4400]/10 transition-colors"
        >
        ...
        <div className="p-6">
          ...
          <div className="space-y-4 text-sm text-[var(--text-secondary)]">
            <div>
              <h3 className="font-bold text-[var(--text-primary)] mb-2">1. Verantwortlicher</h3>
              <p>
                SCND UNIT<br />
            ...
            <div>
              <h3 className="font-bold text-[var(--text-primary)] mb-2">2. Hosting</h3>
              <p>
            ...
            <div>
              <h3 className="font-bold text-[var(--text-primary)] mb-2">3. Erfassung von Daten beim Besuch</h3>
              <p>
            ...
            <div>
              <h3 className="font-bold text-[var(--text-primary)] mb-2">4. Cookies & Local Storage</h3>
              <p>
            ...
            <div>
              <h3 className="font-bold text-[var(--text-primary)] mb-2">5. Externe Links</h3>
              <p>
            ...
            <div>
              <h3 className="font-bold text-[var(--text-primary)] mb-2">6. Deine Rechte</h3>
              <p>
            ...
            <div>
              <h3 className="font-bold text-[var(--text-primary)] mb-2">7. Beschwerderecht</h3>
              <p>
            ...
            <div className="pt-2 text-xs text-[var(--text-secondary)]/60">
          ...
          <div className="mt-6 flex gap-3">
            <button
              ...
              className="flex-1 py-2 bg-[#FF4400] text-white font-bold uppercase tracking-widest text-sm rounded-sm hover:bg-[#FF4400]/80 transition-colors"
            >
              Akzeptieren
            </button>
            <Link
              href="/datenschutz"
              className="flex-1 py-2 border border-[#FF4400]/30 text-[var(--text-secondary)] font-bold uppercase tracking-widest text-sm rounded-sm text-center hover:border-[#FF4400] hover:text-[#FF4400] transition-colors"
              onClick={onClose}
            >
...
export function useDataPrivacy() {
  ...
  useEffect(() => {
    ...
    if (!hasAccepted) {
      // Kurzer Delay, damit die Seite erst geladen ist
