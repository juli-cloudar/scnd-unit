  ...
  if (!user?.permissions.canEditProducts) {
    return (
      <div className="text-center py-20 text-gray-500">
        Keine Berechtigung fuer diese Funktion.
      </div>
    );
  }
            ...
            <div key={product.id} className="bg-[#111] border border-[#FF4400]/20 rounded-lg overflow-hidden">
              ...
              <div className="flex gap-4 p-4 border-b border-gray-800">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <a href={product.vinted_url} target="_blank" rel="noopener noreferrer" className="text-xs text-[#FF4400] hover:underline inline-flex items-center gap-1 mt-1">
